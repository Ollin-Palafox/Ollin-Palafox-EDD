...
public class Stack<E> {
    ...
    public Optional<E> peek() {
        if (isEmpty()) {
            return Optional.empty(); // Devuelve un Optional vacío si la pila está vacía
        }
        return Optional.ofNullable(list.getLast()); // Devuelve un Optional con el último elemento de la pila
    }
